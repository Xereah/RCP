                ...
                <div class="flex items-center space-x-5">
                    <div class="relative">
                        ...
                        <div class="absolute -top-1 -right-1 w-6 h-6 bg-emerald-500 rounded-full flex items-center justify-center">
                            <span class="text-xs font-semibold text-white">{{ count($positions) }}</span>
                        </div>
                    </div>
                    <div>
                        ...
                        <p class="text-lg text-gray-600">Zarządzaj stanowiskami systemu</p>
                    </div>
                </div>
                ...
                <table class="w-full">
                    ...
                    <thead class="bg-gray-50 border-b border-gray-200">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-900 uppercase tracking-wider">Nazwa stanowiska</th>                            
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($positions as $key => $position)
                            <tr class="hover:bg-gray-50 transition-colors duration-150" wire:key="{{ $position->id }}">
                                <!-- Row Number -->
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <button @click="confirmAction('delete', {{ $position->id }}, 'Na pewno chcesz usunąć to stanowisko?', 'Tak, usuń!', 'warning')"
                ...
                <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                    <div class="flex items-center justify-between">
                        <div class="text-sm text-gray-700">
                            Pokazano <span class="font-semibold">{{ $positions->firstItem() }}</span> - 
                            <span class="font-semibold">{{ $positions->lastItem() }}</span> z 
