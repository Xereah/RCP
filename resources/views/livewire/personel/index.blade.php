                ...
                <table class="w-full">
                    ...
                    <thead class="bg-gray-50 border-b border-gray-200">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-900 uppercase tracking-wider">Miejsce pracy</th>                            
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150" wire:key="{{ $personel->id }}">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <a href="{{ route('personels.work-time-regulations', $personel->id) }}" 
                                           wire:navigate
                                           ...
                                           title="Zarządzaj regulaminami czasu pracy">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
