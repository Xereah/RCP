                ...
                <div class="flex items-center space-x-5">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900 mb-1">
                            Tworzenie nowego statusu obecności
                        </h1>
                        <p class="text-lg text-gray-600">Dodaj nowy status obecności do bazy danych</p>
                    </div>
                </div>

                <!-- Back Button -->
                <div class="flex-shrink-0">
                    <a href="{{ route('work-statuses.index') }}" wire:navigate
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-200/50 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-indigo-500 to-indigo-600 px-6 py-4">
                <div class="flex items-center gap-3">
                    ...
                    <h2 class="text-xl font-bold text-white">Formularz nowego statusu obecności</h2>
                </div>
            </div>
            ...
            <div class="p-8">
                <form method="POST" wire:submit="save" role="form" enctype="multipart/form-data">
                    @csrf
                    @include('livewire.work-status.form')
                </form>
            </div>
        </div>
    </div>
