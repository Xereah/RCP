                ...
                <div class="flex items-center space-x-5">
                    <div class="relative">
                        ...
                        <div class="absolute -top-1 -right-1 w-6 h-6 bg-emerald-500 rounded-full flex items-center justify-center">
                            <span class="text-xs font-semibold text-white">{{ count($roles) }}</span>
                        </div>
                    </div>
                    <div>
                        ...
                        <p class="text-lg text-gray-600">Zarządzaj rolami systemu</p>
                    </div>
                </div>
                ...
                <table class="w-full">
                    ...
                    <thead class="bg-gray-50 border-b border-gray-200">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-900 uppercase tracking-wider">Nazwa roli</th>                            
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($roles as $key => $role)
                            <tr class="hover:bg-gray-50 transition-colors duration-150" wire:key="{{ $role->id }}">
                                <!-- Row Number -->
                ...
                <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                    <div class="flex items-center justify-between">
                        <div class="text-sm text-gray-700">
                            Pokazano <span class="font-semibold">{{ $roles->firstItem() }}</span> - 
                            <span class="font-semibold">{{ $roles->lastItem() }}</span> z 
                            <span class="font-semibold">{{ $roles->total() }}</span> wyników
                        </div>
