...
<div class="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
    ...
    <div class="absolute inset-0">
        ...
        <div class="absolute top-20 left-10 w-16 h-16 opacity-20">
            <div class="w-full h-full border-4 border-orange-500 rounded-full animate-spin-slow"
                style="animation-duration: 8s;">
                <div class="absolute inset-2 border-2 border-orange-400 rounded-full">
                    <div class="absolute inset-1 bg-orange-500 rounded-full"></div>
                </div>
            </div>
        </div>
        ...
        <div class="absolute top-0 left-0 w-full h-full opacity-15">
            <svg class="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                <path d="M0,20 Q20,20 20,40 T60,40 Q80,40 80,60 T100,60" stroke="currentColor" stroke-width="0.5"
                    fill="none" class="text-orange-400" />
        ...
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8 animate-fade-in">
                <div class="flex items-center justify-center gap-4">
                    <!-- Ikona -->
                    <div
                        class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl shadow-lg shadow-orange-500/50">
                    ...
                    <div class="text-left">
                        ...
                        <h2 class="text-xl font-semibold text-orange-400 mb-1">RCP Panel</h2>
            ...
            <div
                ...
                <form wire:submit="login" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input wire:model="form.email" id="email" type="email" required autofocus
                                ...
                                class="block w-full pl-10 pr-3 py-3 bg-slate-700/50 border border-slate-600 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200"
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <input wire:model="form.remember" id="remember" type="checkbox"
                                class="h-4 w-4 text-orange-500 focus:ring-orange-500 border-slate-600 rounded bg-slate-700" />
                    ...
                    <!-- Login Button -->
                    <button type="submit"
                        class="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg text-sm font-medium text-white bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 focus:ring-offset-slate-800 transition-all duration-200 transform hover:scale-[1.02] shadow-lg shadow-orange-500/30 hover:shadow-xl hover:shadow-orange-500/40">
                ...
                <div class="mt-8 pt-6 border-t border-slate-700">
                    <div class="text-center">
                        <p class="text-xs text-slate-400 mb-2">
                            Wersja aplikacji: <span class="text-orange-400 font-medium">{{ $appversion }}</span>
                        </p>
    ...
    <div class="absolute bottom-6 left-6 flex space-x-2">
        <div class="w-3 h-3 bg-orange-500 rounded-full animate-pulse shadow-lg shadow-orange-500/50"></div>
